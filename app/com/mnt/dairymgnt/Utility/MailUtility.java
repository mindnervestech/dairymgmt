package com.mnt.dairymgnt.Utility;
...
public void shareJobDetails(String  email,String jobId){
	...
	try {
			...
			message.setFrom(new InternetAddress(username));
			    //Add multiple recipients. including Admin
				message.addRecipients(Message.RecipientType.CC, InternetAddress.parse(email));
				 message.setSubject( "The Following Job Details Have Been Shared With You");
				 BodyPart messageBodyPart = new MimeBodyPart();
				 
				 messageBodyPart.setText("Click  the below link to see the job details \n\nhttp://www.apjobsportal.com/shareJobDetails?jobId="+jobId);
		         // Create a multipart message
		         Multipart multipart = new MimeMultipart();
		         // Set text message part
		         multipart.addBodyPart(messageBodyPart);
